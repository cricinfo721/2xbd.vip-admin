...
const ActiveSpinReport = () => {
  ...
  const getData = async (type = "search") => {
    ...
    let path = apiPath.activespinreport;
                            ...
                            return (
                              <tr key={index}>
                                ...
                                <td>{matchList.spin}</td>
                                 ...
                                 <td>{matchList.lossAmount?.toFixed(2) || 0}</td>
                                 {/* <td>{matchList.spinType || 0}</td> */}
...
export default ActiveSpinReport;
