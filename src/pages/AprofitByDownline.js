...
const AprofitByDownline = () => {
  ...
  const getData = async (type = "search") => {
    ...
    let path = apiPath.reportByDownline;
    try {
                  ...
                  <Table>
                    ...
                    return a;
                      ...
                      <>
                        {data && data?.length > 0 ? (
                          data?.map((item, index) => {
                            return (item?.stake?.amount===0 || item.amount===0)?(""):(
                              <>
                                <tr key={index + 1}>
                                  {/* <td>
                                  <Link
                                    to={`/AprofitByDownline/${item.id}/${item.id}`}
                                  >
                                    ...
                                    <>
                                      <td className="text-start">
                                        {item?.userType == "user" ? (
                                          ...
                                          <>
                                            <Link
                                              to={`/AprofitByDownline/${item._id}/${item?.userType}`}
                                              onClick={() => search(item)}
                                            >
                                              <span>
                                                {
