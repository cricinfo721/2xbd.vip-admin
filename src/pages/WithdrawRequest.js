...
const WithdrwaRequest = () => {
  ...
  const getData = async (obj = filter) => {
    const { status, data: response_users } = await apiGet(
      apiPath.withdrwaRequestListNew,
      {
        page: obj?.page,
        limit: obj?.limit,
      }
      ...
      <section className="main-inner-outer py-4">
        <Container fluid>
          <div className="db-sec">
            <h2 className="common-heading">Withdraw Request</h2>
          </div>
...
export default WithdrwaRequest;
