...
const ACasinoprofitAndLossDownlineNew = () => {
  ...
  const getData = async (type = "search") => {
    ...
    let path = apiPath.ACasinoprofitAndLossDownlineNew;
                                ...
                                <tr key={index + 1}>
                                      ...
                                      <td className="text-start">
                                        {item?.userType == "user" ? (
                                          ...
                                          <>
                                            <Link
                                              to={`/ACasinoprofitAndLossDownlineNew/${item._id}/${item?.userType}`}
                                              onClick={() => search(item)}>
                                              <span>
                                                {
                                                  constant?.user_status[
...
export default ACasinoprofitAndLossDownlineNew;